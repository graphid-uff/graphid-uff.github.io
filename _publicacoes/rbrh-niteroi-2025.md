...
<div class="row">
    ...
    <div class="col-sm-7 mt-3 mt-md-0">
        ...
        <p><strong>Autoria:</strong> Franciele Zanandrea, Gean Paulo Michel, Aimée Guida, Ivanovich Lache Salcedo, Danúbia Teixeira Silva, Camila Athanázio de Azevedo, Lucas da Silva Santos, Isadora Tschiedel Thys & Vanessa Caldas Cardoso</p>
        <p><strong>Publicado em:</strong> Revista Brasileira de Recursos Hídricos (RBRH), v. 30, e34, 2025</p>
        <p>O artigo propõe um método para a criação de um índice de risco qualitativo (IR), aplicado e validado no desenvolvimento do Plano Municipal de Redução de Risco (PMRR) de Niterói. O IR combina o histórico de ocorrências e interdições por deslizamentos, dados de vulnerabilidade socioeconômica e a susceptibilidade do terreno — modelada com o SHALSTAB — para gerar uma hierarquização preliminar das áreas de risco dentro das comunidades, orientando a alocação de recursos técnicos e financeiros.</p>
    </div>
</div>
